	...
	return (
		<div>
			<div  data-aos="fade-top" className="blocks mt-10 flex justify-between items-center gap-24 p-10 sm:gap-4 sm:flex-col lg:gap-24 lg:flex-row">
				<Book img={green} link="./info?name=Green&img=green&version=0&lists=38&words=990&per=66&audio=Good&narx=99 000 / 55 000" />
				<Book img={gold} link="./info?name=Golden&img=gold&version=5&lists=38&words=990&per=33&audio=High&narx=129 000 / 55 000" />
				<Book img={silver} link="./info?name=Silver&img=silver&version=3&lists=44&words=1000&per=40&audio=High&narx=119 000 / 55 000" />
			</div>
